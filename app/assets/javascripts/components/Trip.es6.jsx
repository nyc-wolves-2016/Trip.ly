  ...
  render(){
    ...
    return(
      <div>
        ...
        { this.state.itinerary ? <Itinerary onReturnTripPage={this.handleReturnTripPage} events={this.state.events} itinerary={this.props.itinerary} onErrors={this.handleErrors} errors={this.state.errors} anyForms={this.state.anyForms} onForm={this.handleForms} onFormReset={this.handleResetForms} /> : null }
