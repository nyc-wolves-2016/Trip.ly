      ...
      <div className="row">
        <div className="large-8 column large-centered">
          ...
          <div id="add-errors">
            ...
            { this.state.addEvent ? <AddEventForm data={this.props} onEventSubmit={this.handleEventSubmit} onErrors={this.handleNestedErrors} errors={this.props.errors} anyErrors={this.props.anyErrors}/> : null }
            { this.state.anyForms ? null : <div><button id="event-submit"  className="hollow button" onClick={this.onButtonClick}>Add Event</button></div> }
